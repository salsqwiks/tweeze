...
class CulinaryActivity : AppCompatActivity(), ViewAdapter.OnItemClickListener {
    ...
    private fun performSearch() {
        ...
        if (searchTerm.isNotEmpty()) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                try {
                    val posts = ApiConfig.apiService.getCulinary()
                    ...
                    Toast.makeText(this@CulinaryActivity, "Error fetching data", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun fetchData() {
        GlobalScope.launch(Dispatchers.Main) {
            try {
                ...
                Toast.makeText(this@CulinaryActivity, "Error fetching data: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
