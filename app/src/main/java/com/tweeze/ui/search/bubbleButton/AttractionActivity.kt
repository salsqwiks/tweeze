...
import com.tweeze.databinding.ActivityAttractionBinding
import com.tweeze.databinding.ActivityCulinaryBinding
import com.tweeze.ui.search.detail.DetailActivity
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.launch

class AttractionActivity : AppCompatActivity(), ViewAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.title = "Attraction Search"
    ...
    private fun performSearch() {
        ...
        if (searchTerm.isNotEmpty()) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                try {
                    val posts = ApiConfig.apiService.getAttraction()
                    ...
                    Toast.makeText(this@AttractionActivity, "Error fetching data", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun fetchData() {
        GlobalScope.launch(Dispatchers.Main) {
            try {
                ...
                Toast.makeText(this@AttractionActivity, "Error fetching data: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
