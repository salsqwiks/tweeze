...
import com.tweeze.databinding.ActivityStayBinding
import com.tweeze.ui.search.detail.DetailActivity
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.launch

class StayActivity : AppCompatActivity(), ViewAdapter.OnItemClickListener {
    ...
    private fun performSearch() {
        ...
        if (searchTerm.isNotEmpty()) {
            ...
            GlobalScope.launch(Dispatchers.Main) {
                try {
                    val posts = ApiConfig.apiService.getStay()
                    ...
                    Toast.makeText(this@StayActivity, "Error fetching data", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun fetchData() {
        GlobalScope.launch(Dispatchers.Main) {
            try {
                ...
                Toast.makeText(this@StayActivity, "Error fetching data: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
    }
